...
var setupGetHistoricalDataApi = function (app) {
    app.get("/hive/v2/price-history", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (_a = res.status(200)).send;
                    return [4 /*yield*/, historical_data_logic_1.HistoricalDataLogic.get()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
