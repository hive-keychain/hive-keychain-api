...
exports.MetamaskPhishingLogic = void 0;
...
const getPhishingList = async () => {
    try {
        return JSON.parse(await fs
            .readFileSync(path_1.default.join(__dirname, "..", "..", "..", "..", "..", "json", "phishing-lists", "metamask.json"))
            .toString());
    }
    catch (e) {
        return {
...
const saveMetamaskBlacklistFile = (newList) => {
    try {
        const dirPath = path_1.default.join(__dirname, "..", "..", "..", "..", "..", "json", "phishing-lists");
        const filePath = path_1.default.join(dirPath, "metamask.json");
        ...
        logger_1.default.info(`Updated mm file`);
    }
    catch (e) {
        logger_1.default.info("Failed to update mm file");
        console.log(e);
    }
};
exports.MetamaskPhishingLogic = {
    initFetchMetamaskBlacklist,
    getPhishingList,
};
//# sourceMappingURL=metamask-phishing.logic.js.map